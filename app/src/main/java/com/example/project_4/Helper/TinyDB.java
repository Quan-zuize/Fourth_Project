...
public class TinyDB {
    ...
    public ArrayList<Menu> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Menu> playerList =  new ArrayList<Menu>();

        for(String jObjString : objStrings){
            Menu player  = gson.fromJson(jObjString,  Menu.class);
    ...
    public void putListObject(String key, ArrayList<Menu> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Menu player: playerList){
